...
public class AllyAdjCountComponent extends EvaluatorComponent {

    public AllyAdjCountComponent(byte pieceType, int[] pieceValues, float[] tuningValues) {
    ...
    public static AllyAdjCountComponent generate(byte pieceType) {
        return new AllyAdjCountComponent(pieceType, new int[] {},
                new float[] {(new Random().nextFloat() * 200) - 100});
    }

    @Override
    public String toString() {
        return "AllyAdjCountComponent{" +
                "pieceType=" + pieceType +
