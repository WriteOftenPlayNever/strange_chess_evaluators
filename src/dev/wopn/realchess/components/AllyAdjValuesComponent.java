...
public class AllyAdjValuesComponent extends EvaluatorComponent {

    public AllyAdjValuesComponent(byte pieceType, int[] pieceValues, float[] tuningValues) {
